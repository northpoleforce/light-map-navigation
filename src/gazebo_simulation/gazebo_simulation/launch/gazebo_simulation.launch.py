...
def generate_launch_description():
    ...
    get_package_share_directory('gazebo_simulation'), 'urdf', 'simulation_waking_robot.xacro')])
    ...
    append_enviroment = AppendEnvironmentVariable(
        'GAZEBO_PLUGIN_PATH',
        os.path.join(os.path.join(get_package_share_directory('gazebo_simulation'), 'meshes', 'obstacles', 'obstacle_plugin', 'lib'))
    )
